...
from IVF import IVF_index,semantic_query_ivf

NUMBER_OF_RECORDS_BRUTE_FORCE = 20*10**3
...
class VecDB:
    def __init__(self,file_path="./DataBase", new_db = True) -> None:
            ...
            self.n_regions = None  # Initialize n_regions
    ...
    def _build_index(self,Level_1_nbits=5, Level_2_nbits=3, Level_3_nbits=3,Level_4_nbits=3)-> None:
        ...
        # else:
            ...
            # self.number_of_clusters=NUMBER_OF_RECORDS_BRUTE_FORCE
            # self.n_regions=10
    ...
    def retrive(self, query:Annotated[List[float], 70],top_k = 5)-> [int]:
        ...
        # else: 
        #   n_probes=20
        final_result=semantic_query_ivf(data_file_path=self.file_path,index_folder_path=Level1_folder_path,query=query,top_k=top_k,n_regions=n_probes)
